...
export const resources: Record<string, ResourceConfig> = {
  rooms: {
    ...
    fields: [
      ...
      {
        name: "googleColorId",
        label: "Kolor w Google Calendar",
        type: "select",
        default: "",
        help: "Kolor wydarzeń tego pokoju w Google Calendar. Puste = kolor dobierany automatycznie.",
        options: [
          { value: "", label: "Automatyczny" },
          { value: "1", label: "Lawenda" },
          { value: "2", label: "Szałwia (zielony)" },
          { value: "3", label: "Winogrono (fiolet)" },
          { value: "4", label: "Flaming (róż)" },
          { value: "5", label: "Banan (żółty)" },
          { value: "6", label: "Mandarynka (pomarańcz)" },
          { value: "7", label: "Paw (błękit)" },
          { value: "8", label: "Grafit (szary)" },
          { value: "9", label: "Borówka (granat)" },
          { value: "10", label: "Bazylia (ciemna zieleń)" },
          { value: "11", label: "Pomidor (czerwony)" },
        ],
      },
      {
        name: "theme",
  ...
  packages: {
    label: "Pakiety okazjonalne",
    singular: "pakiet",
    icon: "🎉",
    listColumns: ["namePl", "occasionPl", "priceFrom"],
    fields: [
      { name: "namePl", label: "Nazwa (PL)", type: "text", required: true },
      { name: "nameEn", label: "Nazwa (EN)", type: "text", required: true },
      { name: "slug", label: "Slug (adres URL)", type: "text", required: true, placeholder: "urodziny" },
      { name: "occasionPl", label: "Okazja (PL)", type: "text", placeholder: "np. Urodziny, Wieczór panieński" },
      { name: "occasionEn", label: "Okazja (EN)", type: "text" },
      { name: "taglinePl", label: "Krótki opis (PL)", type: "text" },
      { name: "taglineEn", label: "Krótki opis (EN)", type: "text" },
      { name: "descriptionPl", label: "Pełny opis (PL)", type: "textarea" },
      { name: "descriptionEn", label: "Pełny opis (EN)", type: "textarea" },
      { name: "image", label: "Zdjęcie główne", type: "image" },
      { name: "imagesJson", label: "Galeria pakietu", type: "gallery" },
      { name: "priceFrom", label: "Cena od (zł)", type: "number", default: 0, help: "Cena od — zależnie od liczby osób." },
      { name: "priceNotePl", label: "Dopisek do ceny (PL)", type: "text", placeholder: "np. za grupę / od osoby" },
      { name: "priceNoteEn", label: "Dopisek do ceny (EN)", type: "text" },
      { name: "pricingJson", label: "Cennik (wg liczby osób)", type: "zones", help: "Np. „do 4 osób” — 299 zł, „5–8 osób” — 399 zł." },
      { name: "includesPl", label: "Co zawiera (PL)", type: "textarea", help: "Każda pozycja w osobnej linii." },
      { name: "includesEn", label: "Co zawiera (EN)", type: "textarea" },
      { name: "minPlayers", label: "Min. osób", type: "number", default: 2 },
      { name: "maxPlayers", label: "Maks. osób", type: "number", default: 10 },
      { name: "durationMin", label: "Czas (min)", type: "number", default: 60 },
      { name: "badgePl", label: "Etykieta (PL)", type: "text", default: "Pakiet" },
      { name: "badgeEn", label: "Etykieta (EN)", type: "text", default: "Package" },
      { name: "bookingUrl", label: "Link rezerwacji (opcjonalnie)", type: "text", placeholder: "https://lock.me/..." },
