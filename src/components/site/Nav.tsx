  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-3 md:gap-4">
        ...
        <button className="md:hidden text-2xl" style={{ color: "var(--gold)" }} onClick={() => setOpen((o) => !o)} aria-label="Menu">☰</button>
      </div>

      {open && (
        <div className="md:hidden absolute top-full left-0 right-0 flex flex-col gap-1 p-4" style={{ background: "rgba(4,12,20,.98)", borderBottom: "1px solid var(--border)" }}>
          {links.map((l) => (
