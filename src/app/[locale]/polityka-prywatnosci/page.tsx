  ...
  return (
    <section className="px-6 md:px-[60px] pt-[140px] pb-20 max-w-[800px] mx-auto relative z-[1]">
      ...
      <div className="space-y-5 text-[15px] leading-[1.9]" style={{ color: "var(--muted)" }}>
        ...
        <p>
          {pl
            ? "W sprawach dotyczących danych osobowych skontaktuj się z nami pod adresem artsmysterium@gmail.com."
            : "For matters regarding personal data, contact us at artsmysterium@gmail.com."}
        </p>
      </div>
    </section>
  );
