...
// Publiczny, ładny bon do druku (po kodzie — kod jest sekretem nabywcy).
...
<style>
  ...
  * { box-sizing: border-box; }
  ...
  h1 { font-size:34px; margin:18px 0 4px; color:#e8c97a; }
...
<body>
  <div class="toolbar"><button class="btn" onclick="window.print()">⬇ Pobierz / Drukuj bon</button></div>
  <div class="card">
